...
<title>Zoto 3.0 - Browser Requirements</title>
    ...
    function go_to_new_page() {
		...
		alert("http://www.<?=$domain?>/browser_check/step2/"+window.location.hash);
    	//window.location="http://www.<?=$domain?>/browser_check/step2/"+window.location.hash;
    }
...
switch ($_GET['op']) {
	...
	case "nc":
	?>
		This site requires that your browser accept cookies.  A cookie is a text-only string that gets entered into the memory of your browser.  Zoto uses cookies to provide a quick and convenient means of keeping site content fresh and relevant to your interests.<br /><br />
	...
	?>
		...
		<ul>
			...
			<li><a href='http://www.microsoft.com/windows/ie'>Microsoft Internet Explorer</a> version 7</li>
		...
		if we are not identifying your browser correctly and you are hitting this page in error.
	<?
	break;
	case "ie6":
	?>
		</br>
		<h3><FONT color='FF0000'>You are using Microsoft Internet Explorer 6</FONT></h3>
		</br></br>

		Microsoft Internet Explorer version 6 does not play well with our site. If you insist on using this browser 
		we recommend upgrading to <a href='http://www.microsoft.xom/windows/ie'> Internet Explorer 7</a> (as Microsoft 
		suggests) before continuing. We have found <a href='http://www.mozilla.com'>Firefox</a> to be the best by far. 
		It is fast and adheres to more <a href="http://www.w3.org">W3C</a> standards than other browsers.<br /><br />
		
		Please update from one of the supported browsers listed below. If you wish to continue with your current
		browser, click <a href="javascript:go_to_new_page()">here</a>.
		<ul>
			<lh><h3>supported browsers</h3><lh>
			<li><a href='http://www.microsoft.com/windows/ie'>Microsoft Internet Explorer</a> version 7</li>
