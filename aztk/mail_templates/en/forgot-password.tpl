...
http://www.%(domain)s/reset_password/?hash=%(hash)s&username=%(user.username)s
...
<p><a href="http://www.%(domain)s/reset_password/?hash=%(hash)s&username=%(user.username)s">http://www.%(domain)s/reset_password/?hash=%(hash)s&username=%(user.username)s</a></p>
<p>If you did not request a new password, you may disregard this email.</p>
<p>
Zoto - Where you take your photos.<br/>
<a href="http://www.%(domain)s/">http://www.%(domain)s/</a>
</p>
</div>
</body>
</html>
